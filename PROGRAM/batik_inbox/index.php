...
<body>
<?php include 'client/menu_index.html' ?>
<div id="bodyBG">
    <div id="columnLeft">
         ...
         <div class="isiContentLeft resize_byscreen4"> 
               <table>
                <tr>
                    ...
                    <td style="font-size: 14px; font-family: verdana;"><a href="client/keranjang_belanja.php" class="linknya resize_byscreen10">Keranjang Belanja</a></td>
                </tr>
                </table>
...
-->
         ...
         <table>
            ...
            $tampilkat=mysql_query("SELECT * from kategori");
             ...
             while($result2=mysql_fetch_array($tampilkat))
             {
                ...
                <tr>
                    <td>
                        <li style=color:#74cd00;><a href=client/view_produkbykate.php?idkat=$result2[id_kategori] class=linknya>$namakat</a>
                    </td>
                </tr>
                ";                   
                }
        ...
        <table >
          <span style="font-size: 12px; color: #d1d1d1;">
             <img src="image/icon/bank-mandiri-logo1.jpg" width="160px" style="display: block;   margin-left:5px;   margin-right: auto; " class="resize_byscreen5"/>
            ...
            Bila sudah membayar, silahkan konfirmasi<br />
               ...
               <span style="color:#ec2e03;">
                <a href="client/form_konfirmasi.php" style=" font-size:18px; text-decoration:none;" class="linknya">
                KLIK DISINI</a> 
               </span>
            </p> 
          </span>
  ...
  <div id="header"><div class="wrap">
   <div id="slide-holder">
    <div id="slide-runner">
    <a href=""><img id="slide-img-1" src="jquery_slideshow/images/banner_slideshow1.png" class="slide resize_byscreen15" alt="" /></a>
    <a href=""><img id="slide-img-2" src="jquery_slideshow/images/banner_slideshow2.png" class="slide resize_byscreen15" alt="" /></a>
    <a href=""><img id="slide-img-3" src="jquery_slideshow/images/banner_slideshow3.png" class="slide resize_byscreen15" alt="" /></a>

    <a href=""><img id="slide-img-4" src="jquery_slideshow/images/banner_slideshow4.png" class="slide resize_byscreen15" alt="" /></a>
    <a href=""><img id="slide-img-5" src="jquery_slideshow/images/banner_slideshow5.png" class="slide resize_byscreen15" alt="" /></a>
    <div id="slide-controls" class="resize_byscreen16">
	                   ...
	                   <td width=290px class=jarakPerKolom valign='top'>
                            <table border=0 width=190px class=styleTeksProduk resize_byscreen6>
				                <form method='post' action='client/input_belanja.php'>
                                    ...
                                    <tr>	 
                                        <td>
                                        <a href=client/view_produkdetail.php?id=$idprod class=button2 serif round style=width: 66px; height: 15px;font-size: 15px; name=view>Detail</a>
                                        </td>
                                        <td></td>
                                        <td>
