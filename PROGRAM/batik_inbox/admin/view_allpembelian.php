    ...
    <div id="columnRight">
        ...
        <div class="styleTabel">
         <div class="buttonPutih3" style="width: 700px;padding-left: 2px;">
            ...
            <div class="kolomSubJudul2">&nbsp;&nbsp;Lihat semua transaksi, dengan urutan tanggal paling baru</div>
        </div>
        <?php
            ...
            $tampil=mysql_query("SELECT * FROM pembelian ORDER BY id_pembelian DESC LIMIT $posisi,$batas");
            $no=1;
