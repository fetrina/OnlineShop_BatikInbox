    ...
    <div id="columnRight">
        ...
        <div class="styleTabel">
         <div class="buttonPutih3" style="width: 700px;padding-left: 2px;">
            ...
            <div class="kolomSubJudul2">&nbsp;&nbsp;Lihat semua transaksi berstatus "baru beli", yang belum dilihat</div>
        </div>
        <?php
            ...
            $tampil=mysql_query("SELECT * FROM pembelian WHERE status_pembelian='baru beli' AND status_dilihat='belum' ORDER BY id_pembelian DESC LIMIT $posisi,$batas");
            $no=1;
